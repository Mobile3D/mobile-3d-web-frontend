          ...
          <Grid container className={classes.options} justify="center" spacing={4}>
            <Grid item>
              <Link to="/print" className={classes.link} >
                <ActionCard action="print" title="Print" description="Upload a file and print it" />
              </Link>
            </Grid>
            <Grid item>
              <Link to="/controls" className={classes.link} >
                <ActionCard action="control" title="Controls" description="Control your 3D-Printer manually" />
              </Link>
            </Grid>
            <Grid item>
              <Link to="/files" className={classes.link} >
                <ActionCard action="files" title="Files" description="View files you've already uploaded and print them again" />
              </Link>
            </Grid>
          </Grid>
        </Grid>
